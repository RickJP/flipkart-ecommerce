...
export const initialDataConstants = {
  ...
  GET_ALL_INITIAL_DATA_SUCCESS: 'GET_ALL_INITIAL_DATA_UCCESS',
...
export const bilingualConstants = {
  GET_BILINGUAL_DOCS_REQUEST: 'GET_BILINGUAL_DOCS_REQUEST',
  GET_BILINGUAL_DOCS_SUCCESS: 'GET_BILINGUAL_DOCS_SUCCESS',
  GET_BILINGUAL_DOCS_FAILURE: 'GET_BILINGUAL_DOCS_FAILURE',
};
